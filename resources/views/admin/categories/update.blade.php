                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form action="{{ url('admin/category/update', ['id' => $category->id]) }}" method="post" class="form-horizontal">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="text" id="text-input" name="name" value="{{ old('name') ? old('name') : $category->name }}"
                                                   class="form-control">
                                        </div>
                                    </div>
                                    <div class="row form-group">
