...
@section('title', 'Thêm mới màu sản phẩm')
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong>Thêm mới</strong> màu sản phẩm
                            </div>
                            @if ($errors->any())
                            ...
                            <div class="card-body card-block">
                                <form action="{{ url('admin/color/create') }}" method="post" class="form-horizontal">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="text" id="text-input" name="color" placeholder="Nhập màu"
                                                   class="form-control">
                                        </div>
                                    </div>
                                    <div class="row form-group">
