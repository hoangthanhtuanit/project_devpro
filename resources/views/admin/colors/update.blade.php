...
@section('title', 'Cập nhật màu sản phẩm')
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong>Cập nhật</strong> màu sản phẩm
                            </div>
                            @if ($errors->any())
                            ...
                            <div class="card-body card-block">
                                <form action="{{ url('admin/color/update', ['id' => $color->id]) }}" method="post" class="form-horizontal">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="text" id="text-input" name="color" value="{{ old('color') ? old('color') : $color->color }}"
                                                   class="form-control">
                                        </div>
                                    </div>
                                    <div class="row form-group">
