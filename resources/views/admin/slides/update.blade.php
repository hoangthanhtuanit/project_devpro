                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form action="{{ url('admin/slide/update', ['id' => $slide->id]) }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="text" id="text-input" value="{{ old('title') ? old('title') : $slide->title }}" name="title" placeholder="Nhập tiêu đề"
                                                   class="form-control">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <p><img width="250" height="100" src="{{ asset('/uploads/slides/' . $slide->image) }}" alt=""></p>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="text" id="text-input" value="{{ old('summary') ? old('summary') : $slide->summary }}" name="summary" placeholder="Nhập mô tả"
                                                   class="form-control">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="text" id="text-input" name="position" value="{{ old('position') ? old('position') : $slide->position }}" placeholder="Nhập vị trí hiển thị"
                                                   class="form-control">
                                        </div>
                                    </div>
                                    <div class="row form-group">
