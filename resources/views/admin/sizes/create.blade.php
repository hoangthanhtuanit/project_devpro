                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong>Thêm mới</strong> kích cỡ
                            </div>
                            @if ($errors->any())
                            ...
                            <div class="card-body card-block">
                                <form action="{{ url('admin/size/create') }}" method="post" class="form-horizontal">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
                                            <input type="text" id="text-input" name="size" placeholder="Nhập kích cỡ"
                                                   class="form-control">
                                        </div>
                                    </div>
                                    <div class="row form-group">
