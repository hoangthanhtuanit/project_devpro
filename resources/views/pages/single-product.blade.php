            ...
            <div class="row s_product_inner">
                ...
                <div class="col-lg-5 offset-lg-1">
                    <div class="s_product_text">
                        <h3>{{ $product->name }}</h3>
                        @if(($product->sale) > 0)
                            <h2><strike style="color: #fe8618">{{ number_format($product->price) }} VNĐ</strike></h2>
                            <h2>{{ number_format(((100 - $product->sale) * $product->price)/100) }} VNĐ</h2>
                        @else
                            <h2>{{ number_format($product->price) }} VNĐ</h2>
                        @endif
                        <ul class="list">
                            <li><a class="active" href="#"><span>Danh mục</span> : {{ $product->categories->name }}</a>
                            </li>
                            @php
                                $availability = '';
                        ...
                        <form action="{{ url('add-cart', ['id' => $product->id]) }}" method="get">
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td>&nbsp;&nbsp;</td>
                                    <td>
                                        <select name="color" class="input-text">
                            ...
                            <div class="submit" style="margin-top: 25px;">
                                <button class="button primary-btn" type="submit">Mua ngay</button>
                            </div>
                        </form>
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab"
                       ...
                       aria-selected="false">Đặc điểm chi tiết</a>
                </li>
                <li class="nav-item">
